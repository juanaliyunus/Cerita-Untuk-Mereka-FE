...
const HomePage = () => {
  ...
  const TotalOrphanagesCard = () => {
    ...
    if (loading) return <p>Memuat data...</p>; // Tampilkan saat loading
    if (error) return <p>{error}</p>; // Tampilkan error jika ada
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="p-6 bg-gradient-to-r from-purple-500 to-purple-700 shadow-lg text-white">
            <h3 className="text-lg font-semibold">Total Donatur Terdaftar</h3>
            <p className="text-3xl font-bold">500</p>
          </Card>
          <Card className="p-6 bg-gradient-to-r from-green-400 to-green-600 shadow-lg text-white">
        ...
        {/* Grafik Donasi Buku dan Status Konfirmasi Buku */}
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <ul className="divide-y divide-gray-200">
            <li className="py-4">Panti A - 200 Buku</li>
            <li className="py-4">Panti B - 150 Buku</li>
          </ul>
        </div>
      </div>
    </div>
